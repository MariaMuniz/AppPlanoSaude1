...
import com.example.cida.chbsaude.Entidades.Idades;
...
public class IdadesDAO extends DAOBasico<Idades>   {
        ...
        public ContentValues entidadeParacontentValues(Idades idades) {
            ...
            if(idades.getId() > 0) {
                values.put(COLUNA_ID, idades.getId());
            }
            // values.put(COLUNA_ID_OPERADORA, plano.getIdOperadora());
            //values.put(COLUNA_NOME, plano.getNome());
