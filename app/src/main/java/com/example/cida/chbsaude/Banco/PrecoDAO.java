...
import com.example.cida.chbsaude.Entidades.Preco;
...
public class PrecoDAO extends DAOBasico<Preco> {
    ...
    public static final String COLUNA_ID_SUBOPERADORA = "id_suboperadora";


    public static final String SCRIPT_CRIACAO_TABELA_PRECO = "CREATE TABLE " + NOME_TABELA + "(" + COLUNA_ID + " INTEGER PRIMARY KEY,"
            + COLUNA_VALOR + " DOUBLE," + COLUNA_ID_PLANO + " INTEGER," + COLUNA_ID_OPERADORA + " INTEGER," + COLUNA_ID_SUBOPERADORA + " INTEGER" + ") ";
    ...
    public ContentValues entidadeParacontentValues(Preco preco) {
        ...
        values.put(COLUNA_ID_SUBOPERADORA, preco.getIdSuboperadora());
    ...
    public Preco contentValuesParaEntidade(ContentValues contentValues) {
        ...
        preco.setIdSuboperadora(contentValues.getAsInteger(COLUNA_ID_SUBOPERADORA));
